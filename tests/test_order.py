...
class TestOrder:
    ...
    def test_successfull_orden_creation(self, data_set, driver):
        ...
        order_page.add_client_data(OrderPageData.data[data_set].get('name'),
                                   OrderPageData.data[data_set].get('surname'),
                                   OrderPageData.data[data_set].get('address'),
                                   OrderPageData.data[data_set].get('metro_name'),
                                   OrderPageData.data[data_set].get('phone_number'))
        order_page.wait_for_load_order_form_with_characteristics()
        order_page.add_order_data(OrderPageData.data[data_set].get('data'),
                                  OrderPageData.data[data_set].get('rent_period'),
                                  OrderPageData.data[data_set].get('color'),
                                  OrderPageData.data[data_set].get('comment'))
